...
//     and statNames (["wit","charm","luck","curiosity","nerve"]) to the API
...
const CUSTOM_INPUT_SPREAD = { wit: 3, charm: 3, luck: 3, curiosity: 3, nerve: 3 };
